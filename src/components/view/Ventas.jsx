...
import Producto from "../resource/Producto.jsx";
import Descripcion from "../resource/Descripcion.jsx";
import Store from "../resource/Store.jsx";
...
const Ventas = () => {
  ...
  const incrementCounter = (productId) => {
    ...
    const counterIndex = updatedCounters?.findIndex(
      (counter) => counter.nombre === productId
    );
              ...
              <div key={x.id}>
                ...
                <div className="divButtonP">
                  ...
                  <p className="mx-1 bg-indigo-200 rounded-md px-2">
                    {(counters &&
                      counters.find((counter) => counter.nombre === x.nombre)
                        ?.count) ||
                      0}
                  </p>
                  <TiPlusOutline
